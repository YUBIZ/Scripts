...
// GenerateFilePathAndCommitHistoryCollection Command
{
    ...
    GenerateFilePathAndCommitHistoryCollectionCommand.SetHandler(GenerateFilePathAndCommitHistoryCollection, argument, argument1, option, option1);
...
// GenerateSitemap Command
{
    ...
    Argument<string> argument2 = new("base-url", "loc 항목의 접두사입니다.");
